...
PROJECT_NAME='SimpleVLA-TTRL-Moderate'
EXPERIMENT_NAME='vla_ttrl_32prompts_5votes_1sample' 
...
# 按照你的需求配置：
# - 32个不同的observation/prompt (减少batch size)
# - 每个prompt生成5条完整轨迹进行投票
# - 总计32 × 5 = 160条轨迹候选
# - 从5条中选1条用于训练
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    +vla_ttrl.rollout_batch_size=32 \
