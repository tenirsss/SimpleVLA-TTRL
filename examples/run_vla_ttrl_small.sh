#!/bin/bash
# VLA-TTRL训练脚本 - 小batch测试版
# 配置: 16个prompts × 5条投票轨迹 = 80条轨迹候选
...
PROJECT_NAME='SimpleVLA-TTRL-Small'
EXPERIMENT_NAME='vla_ttrl_16prompts_5votes_test' 
...
HYDRA_FULL_ERROR=1 python -u -m verl.trainer.main_ppo \
    ...
    +vla_ttrl.rollout_batch_size=16 \
